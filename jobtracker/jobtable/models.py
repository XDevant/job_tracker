...
class Prospect(models.Model):
    ...
    email = models.EmailField(max_length=64, null=True)
    comments = models.TextField(max_length=750, null=True)
...
class Mail(models.Model):
    ...
    you = models.TextField(max_length=750, default=cover_template["you"], null=True)
    me = models.TextField(max_length=750, default=cover_template["me"], null=True)
    us = models.TextField(max_length=750, default=cover_template["us"], null=True)
...
class Appointment(models.Model):
    ...
    type = models.CharField(max_length=18, default=Type.TECH, choices=Type.choices)
    ...
    contact = contact = models.ForeignKey(
        to=Contact,
        on_delete=models.CASCADE,
        related_name='appointment_contact',
    )
...
class Application(models.Model):
    ...
    appointments = models.ManyToManyField(to=Appointment, through='Meeting')
    ...
    comments = models.TextField(max_length=750, default=None, null=True)
...
class Meeting(models.Model):
    application = models.ForeignKey(
                                    to=Application,
                                    on_delete=models.CASCADE,
                                    related_name='meeting_application',
                                    )
    appointment = models.ForeignKey(
                             to=Appointment,
                             on_delete=models.CASCADE,
                             related_name='meeting_appointment',
                             )
